...
class LinkedListSplitIteratorExampleTest {
    ...
    void multiplyEachValue() {
        ...
        //when
        List<Integer> resultList = linkedListSplitIteratorExample.multiplyEachValue(inputList, 2, false);
    ...
    void multiplyEachValue_parallel() {
        ...
        //when
        List<Integer> resultList = linkedListSplitIteratorExample.multiplyEachValue(inputList, 2, true);
